 ...
 * @author  oestadho
 */
public class FrmNota080807 extends javax.swing.JInternalFrame {
...
//                lblTglBerangkat.setText("");
            ...
            Logger.getLogger(FrmNota080807.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
private void txtNoNotaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNoNotaKeyReleased
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmNota080807().setVisible(true);
            }
        });
    }
...
//            rsD=stD.executeQuery("select * from nota_detail limit 0");
            ...
            try {
                ...
                Logger.getLogger(FrmNota080807.class.getName()).log(Level.SEVERE, null, ex1);
            }
