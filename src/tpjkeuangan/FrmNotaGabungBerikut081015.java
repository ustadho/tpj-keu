 ...
 * @author  oestadho
 */
public class FrmNotaGabungBerikut081015 extends javax.swing.JDialog {
    Connection conn;
    ...
    private NumberFormat dcFmt=new DecimalFormat("#,##0");
    ...
    public FrmNotaGabungBerikut081015(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private String udfGetNewNota(){
        ...
        try{
            ...
            ResultSet rs=stm.executeQuery("select fn_nota_get_new_kode_tagihan('"+sKodeCustomer+"', '"+fmtYMD.format(jDateNota.getDate())+"')");
...
//            }
            ...
            try {
                ...
                Logger.getLogger(FrmNotaGabungBerikut081015.class.getName()).log(Level.SEVERE, null, ex1);
            }
...
//        }
    ...
    private void initComponents() {
        ...
        panelItem.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 780, 160));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 390, -1, 110));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 490, 180, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 420, 120));
            ...
            switch(evt.getKeyCode()) {
                ...
                default : {
                    ...
                    try {
                        ...
                        Logger.getLogger(FrmNotaGabungBerikut081015.class.getName()).log(Level.SEVERE, null, ex);
                    }
...
if(lst.isVisible()){return;}
        ...
        if(!txtQty.getText().equalsIgnoreCase("0")){
            txtSubTotal.setText(dcFmt.format(udfGetFloat(txtQty.getText()) * udfGetFloat(txtTarif.getText()) ) );
        }else{
            txtQty.setText("");
        }
...
private void txtSubTotalFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtSubTotalFocusLost
    txtSubTotal.setText(fmt.format(udfGetFloat(txtSubTotal.getText())));
        ...
        if(udfGetFloat(txtSubTotal.getText())!=udfGetFloat(dcFmt.format(udfGetFloat(txtQty.getText())*udfGetFloat(txtTarif.getText()))) && 
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmNotaGabungBerikut081015 dialog = new FrmNotaGabungBerikut081015(new javax.swing.JFrame(), true);
