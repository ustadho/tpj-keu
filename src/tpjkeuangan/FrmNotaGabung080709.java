 ...
 * @author  oestadho
 */
public class FrmNotaGabung080709 extends javax.swing.JInternalFrame {
    private Connection conn;
    DefaultTableModel itemModel, notaModel;
    ...
    public FrmNotaGabung080709() {
        ...
        itemModel=(DefaultTableModel)tblItem.getModel();
        ...
        try {
            ...
            if(rsH.next()){
                ...
                //String sDet="select no_nota from nota where nota_header='"+txtNoNota.getText()+"'";
                 ...
                 String sDet="select nota.no_nota, coalesce(nama_kapal||', Berangkat Tgl '||fn_tanggal_ind(nota.tgl_nota),'') as kapal_berangkat, " +
                            ...
                            "group by nota.no_nota, coalesce(nama_kapal||', Berangkat Tgl '||fn_tanggal_ind(nota.tgl_nota),'') order by nota.no_nota";
...
//                lblTglBerangkat.setText("");
    ...
    private void udfProsesKoreksi(){
        ...
        sKoreksi+="insert into nota_history_detail(no_nota, merk, item_trx, ukuran, satuan, ket_satuan, tarif, sub_total) " +
                ...
                "where no_nota='"+sOldNota+"' or nota_header='"+sOldNota+"';";
...
//            rsD=stD.executeQuery("select * from nota_detail limit 0");
            ...
            for (int s=0; s<itemModel.getRowCount(); s++){
                
                sInsert+="Insert into nota_detail(no_nota, merk, item_trx, satuan, ket_satuan, ukuran, tarif, sub_total) values " +
                        "('"+txtNoNota.getText()+"', '"+ itemModel.getValueAt(s, 0).toString()+"', " +
                        "'"+itemModel.getValueAt(s, 1).toString()+"', '"+itemModel.getValueAt(s, 3).toString()+"', " +
                        "'"+itemModel.getValueAt(s, 4).toString()+"', " +
                        (udfGetFloat(itemModel.getValueAt(s, 2).toString())>0? udfGetFloat(itemModel.getValueAt(s, 2).toString()) :null)+", " +
                        (udfGetFloat(itemModel.getValueAt(s, 5).toString())>0? udfGetFloat(itemModel.getValueAt(s, 5).toString()) :null)+", " +
                        udfGetFloat(itemModel.getValueAt(s, 6).toString())+"); " ;
            }
            
            stD.executeUpdate(sInsert);
            
            String sUpdate="Update nota set nota_header=null where nota_header='"+txtNoNota.getText()+"'; ";
            for (int s=0; s<notaModel.getRowCount(); s++){
                if(!notaModel.getValueAt(s, 6).toString().equalsIgnoreCase(""))
                    sUpdate+="Update nota set nota_header='"+txtNoNota.getText()+"' where no_nota='"+notaModel.getValueAt(s, 6).toString()+"'; ";
            }
    ...
    private void udfSetKeterangan(){
        try {
            ...
            Logger.getLogger(FrmNotaGabung080709.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//            rsD=stD.executeQuery("select * from nota_detail limit 0");
    ...
    private void initComponents() {
        ...
        panelNotaNext = new javax.swing.JPanel();
        jScrollPane5 = new javax.swing.JScrollPane();
        tblNota1 = new javax.swing.JTable();
        btnAddNota1 = new javax.swing.JButton();
        txtNoNotaDetail1 = new javax.swing.JTextField();
        lblKapalBerangkat1 = new javax.swing.JLabel();
        lblJmlNota1 = new javax.swing.JLabel();
        ...
        tblNota.setAutoCreateRowSorter(true);
        ...
        tblNota.getColumnModel().getColumn(1).setPreferredWidth(250);
        tblNota.getColumnModel().getColumn(2).setPreferredWidth(60);
        ...
        tblNota.getColumnModel().getColumn(6).setPreferredWidth(120);

        panelNotaLalu.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(4, 51, 780, 120));
        ...
        txtNoNotaDetail.setFont(new java.awt.Font("Dialog", 0, 12));
        ...
        panelNotaNext.setBackground(new java.awt.Color(204, 204, 204));
        panelNotaNext.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        panelNotaNext.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        tblNota1.setAutoCreateRowSorter(true);
        tblNota1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblNota1.getTableHeader().setReorderingAllowed(false);
        tblNota1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tblNota1KeyPressed(evt);
            }
        });
        jScrollPane5.setViewportView(tblNota1);
        tblNota1.getColumnModel().getColumn(0).setPreferredWidth(100);
        tblNota1.getColumnModel().getColumn(1).setPreferredWidth(250);
        tblNota1.getColumnModel().getColumn(2).setPreferredWidth(60);
        tblNota1.getColumnModel().getColumn(3).setPreferredWidth(80);
        tblNota1.getColumnModel().getColumn(4).setPreferredWidth(80);
        tblNota1.getColumnModel().getColumn(5).setPreferredWidth(100);
        tblNota1.getColumnModel().getColumn(6).setPreferredWidth(120);

        panelNotaNext.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(4, 51, 780, 120));

        btnAddNota1.setText("+");
        btnAddNota1.setToolTipText("Tambahkan ke nota gabungan");
        btnAddNota1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnAddNota1MouseClicked(evt);
            }
        });
        btnAddNota1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddNota1ActionPerformed(evt);
            }
        });
        btnAddNota1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnAddNota1KeyPressed(evt);
            }
        });
        panelNotaNext.add(btnAddNota1, new org.netbeans.lib.awtextra.AbsoluteConstraints(783, 22, 40, -1));

        txtNoNotaDetail1.setFont(new java.awt.Font("Dialog", 0, 12));
        txtNoNotaDetail1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        txtNoNotaDetail1.setDisabledTextColor(new java.awt.Color(153, 153, 153));
        txtNoNotaDetail1.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtNoNotaDetail1FocusLost(evt);
            }
        });
        txtNoNotaDetail1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtNoNotaDetail1KeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtNoNotaDetail1KeyReleased(evt);
            }
        });
        panelNotaNext.add(txtNoNotaDetail1, new org.netbeans.lib.awtextra.AbsoluteConstraints(3, 23, 170, 24));

        lblKapalBerangkat1.setBackground(new java.awt.Color(255, 255, 255));
        lblKapalBerangkat1.setFont(new java.awt.Font("Dialog", 0, 12));
        lblKapalBerangkat1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        lblKapalBerangkat1.setOpaque(true);
        panelNotaNext.add(lblKapalBerangkat1, new org.netbeans.lib.awtextra.AbsoluteConstraints(172, 23, 480, 24));

        lblJmlNota1.setBackground(new java.awt.Color(255, 255, 255));
        lblJmlNota1.setFont(new java.awt.Font("Dialog", 0, 12));
        lblJmlNota1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        lblJmlNota1.setOpaque(true);
        panelNotaNext.add(lblJmlNota1, new org.netbeans.lib.awtextra.AbsoluteConstraints(652, 23, 130, 24));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel15.setText("JML. NOTA");
        jLabel15.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jLabel15.setOpaque(true);
        panelNotaNext.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(652, 8, 130, -1));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel16.setText("NO. NOTA");
        jLabel16.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jLabel16.setOpaque(true);
        panelNotaNext.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(3, 8, 170, -1));

        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel17.setText("KAPAL ~ ");
        jLabel17.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jLabel17.setOpaque(true);
        panelNotaNext.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(172, 8, 480, -1));

        jTabbedPane1.addTab("Nota Kapal Berikutnya", panelNotaNext);
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        notaModel=(DefaultTableModel)tblNota.getModel();
        notaModel.setNumRows(0);
        ...
        tblNota.getModel().addTableModelListener(new MyTableModelListener(tblNota));
        ...
        for (int i=0;i<tblNota.getColumnCount();i++){
            tblNota.getColumnModel().getColumn(i).setCellRenderer(rndNota);
        }
    ...
    private void tblNotaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblNotaKeyPressed
        int iRow=tblNota.getSelectedRow();
...
//            txtSubTotal.setText(fmt.format((Float)itemModel.getValueAt(iRow, 6)));
        ...
        }if(evt.getKeyCode()==KeyEvent.VK_DELETE && !(notaModel.getValueAt(iRow, 6).toString().equalsIgnoreCase(""))){
            
            notaModel.removeRow(iRow);
            
            while(iRow<notaModel.getRowCount() && notaModel.getValueAt(iRow, 6).toString().equalsIgnoreCase("")){
                notaModel.removeRow(iRow);
            }
        }
        else{
    ...
    private void txtNoNotaDetailKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNoNotaDetailKeyReleased
        String sQry="select nota.no_nota, coalesce(nama_kapal||', Berangkat Tgl '||fn_tanggal_ind(nota.tgl_nota),'') as kapal_berangkat, " +
                "sum(coalesce(sub_total,0)) as sub_total " +
                "from nota " +
                "inner join nota_detail d on nota.no_nota=d.no_nota " +
                "left join nota_kapal_tujuan ktj on seri_kapal=serial_kode " +
                "left join kapal on kapal.kode_kapal=ktj.kode_kapal " +
                "where coalesce(nota_header,'')='' " +
                "and customer='"+txtToko.getText()+"' " +
                "and tagihan_per='"+(radioToko.isSelected()? "T":"P")+"' " +
                "group by nota.no_nota, coalesce(nama_kapal||', Berangkat Tgl '||fn_tanggal_ind(nota.tgl_nota),'') order by nota.no_nota";
    ...
    private void tblItemKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblItemKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_F3){
            ...
            if(tblNota.getSelectedRow()>=0){
                itemModel.removeRow(tblNota.getSelectedRow());
                return;
            }
        } 
        else{
    ...
    private void txtQtyFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtQtyFocusLost
        ...
        if(!txtQty.getText().equalsIgnoreCase("0")){
            txtSubTotal.setText(fmt.format(udfGetFloat(txtQty.getText()) * udfGetFloat(txtTarif.getText()) ) );
        }else{
            txtQty.setText("");
        }
    ...
    private void txtSubTotalFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtSubTotalFocusLost
        ...
        if(udfGetFloat(txtSubTotal.getText())!=(udfGetFloat(txtQty.getText())*udfGetFloat(txtTarif.getText())) &&
...
private void tblNota1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblNota1KeyPressed
// TODO add your handling code here:
}//GEN-LAST:event_tblNota1KeyPressed

private void btnAddNota1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddNota1MouseClicked
// TODO add your handling code here:
}//GEN-LAST:event_btnAddNota1MouseClicked

private void btnAddNota1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddNota1ActionPerformed
// TODO add your handling code here:
}//GEN-LAST:event_btnAddNota1ActionPerformed

private void btnAddNota1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnAddNota1KeyPressed
// TODO add your handling code here:
}//GEN-LAST:event_btnAddNota1KeyPressed

private void txtNoNotaDetail1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNoNotaDetail1FocusLost
// TODO add your handling code here:
}//GEN-LAST:event_txtNoNotaDetail1FocusLost

private void txtNoNotaDetail1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNoNotaDetail1KeyPressed
// TODO add your handling code here:
}//GEN-LAST:event_txtNoNotaDetail1KeyPressed

private void txtNoNotaDetail1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNoNotaDetail1KeyReleased
// TODO add your handling code here:
}//GEN-LAST:event_txtNoNotaDetail1KeyReleased
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmNotaGabung080709().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnAddNota1;
    ...
    private javax.swing.JLabel lblJmlNota1;
    private javax.swing.JLabel lblKapal;
    private javax.swing.JLabel lblKapalBerangkat;
    private javax.swing.JLabel lblKapalBerangkat1;
    ...
    private javax.swing.JPanel panelNotaNext;
    ...
    private javax.swing.JTable tblNota1;
    ...
    private javax.swing.JTextField txtNoNotaDetail1;
    ...
    private void udfClear() {
        if(itemModel.getRowCount()>0 && !isSave){
        ...
        itemModel.setNumRows(0); notaModel.setNumRows(0);
//        tblNota.setModel(notaModel); 
//        tblItem.setModel(itemModel);
...
//        
        for(int i=0; i<notaModel.getRowCount(); i++){
            if(!isKoreksi && notaModel.getValueAt(i, 6).toString().trim().equalsIgnoreCase(txtNoNotaDetail.getText())){
...
//    
    private void udfAddItemTrx(){
        ...
        if(!isEditRow){
            ...
            itemModel.setValueAt(txtMerk.getText(), tblItem.getSelectedRow(), 0);
            itemModel.setValueAt(txtItemTrx.getText(), tblItem.getSelectedRow(), 1);
            itemModel.setValueAt((udfGetFloat(txtQty.getText())<=0? "": udfGetFloat(txtQty.getText())) , tblItem.getSelectedRow(), 2);
            itemModel.setValueAt(txtSatuan.getText(), tblItem.getSelectedRow(), 3);
            itemModel.setValueAt(txtKetSatuan.getText(), tblItem.getSelectedRow(), 4);
            itemModel.setValueAt((udfGetFloat(txtTarif.getText())<=0? "": udfGetFloat(txtTarif.getText()) ), tblItem.getSelectedRow(), 5);
            itemModel.setValueAt(udfGetFloat(txtSubTotal.getText()), tblItem.getSelectedRow(), 6);
            isEditRow=false;
        }
    ...
    private void udfSetTotal(){
        ...
        for (i=0; i<itemModel.getRowCount();i++){
            total = total+ udfGetFloat(itemModel.getValueAt(i, 6).toString());
        }
        for (i=0; i<notaModel.getRowCount();i++){
            total = total+ udfGetFloat(notaModel.getValueAt(i, 5).toString());
        }
    ...
    private void udfSave(){
        ...
        if(notaModel.getRowCount()==0){
            if(JOptionPane.showConfirmDialog(this, "Nota yang akan digabungkan masih belum dipilih!\n" +
                    "Apakah simpan data akan dilajtkan?", "Nota lain", JOptionPane.YES_NO_CANCEL_OPTION)==JOptionPane.NO_OPTION){
                    jTabbedPane1.setSelectedIndex(0);
                    txtMerk.requestFocus();
                    return;
            }
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(FrmNotaGabung080709.class.getName()).log(Level.SEVERE, null, ex1);
            }
